class ArtifactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @artifact.save
        format.html { redirect_to tenant_project_url(tenant_id: @artifact.project.tenant.id, id: @artifact.project_id), notice: "Artifact was successfully created." }
  ...
  def destroy
    tenant = @artifact.project.tenant
    @artifact.destroy

    respond_to do |format|
      format.html { redirect_to tenant_project_url(tenant_id: tenant.id, id: @artifact.project_id), notice: "Artifact was successfully destroyed." }
